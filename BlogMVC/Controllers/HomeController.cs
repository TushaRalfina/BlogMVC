...
namespace BlogMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> SignUp(UserViewModel userViewModel)
        {
            ...
            {
                ViewBag.SignupNotification = "An error occurred while signing up: " + ex.Message;
                return View(userViewModel);
            }
        }
        ...
        **/
        private async Task<string> ValidateUser(UserViewModel userViewModel)
        {
            ...
            catch (Exception ex)
            {
                ...
                return "An error occurred while validating user";
            }
        }
        ...
        public ActionResult VerifyEmail(string verificationCode)
        {
            ...
            {
                ViewBag.Notification = "An error occurred while verifying email: " + ex.Message;
                return View();
            }
        }
        ...
        public ActionResult Login(user user)
        {
            ...
            {
                ViewBag.LoginNotification = "An error occurred while logging in: " + ex.Message;
                return View("SignUp");
            }
        }
        ...
        public ActionResult Index(int? page, string category, string sortBy, DateTime? fromDate, DateTime? toDate)
        {
            ...
            {
                ViewBag.Notification = "An error occurred while fetching posts and showing index page: " + ex.Message;
                return View();
            }
        }
        ...
        public ActionResult Profile()
        {
            ...
            {
                ViewBag.Notification = "An error occurred while fetching user profile: " + ex.Message;
                return View();
            }
        }
        ...
        public ActionResult DownloadFile(int fileId)
        {
            ...
            {
                ViewBag.Notification = "An error occurred while downloading the file: " + ex.Message;
                return View();
            }
        }
        ...
        **/
        public ActionResult Categories(int category_id)
        {
            ...
            {
                ViewBag.Notification = "An error occurred while fetching posts by category: " + ex.Message;
                return View();
            }
        }
